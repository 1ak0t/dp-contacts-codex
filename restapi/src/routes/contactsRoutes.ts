...
import { createEmployee, deleteEmployee, listEmployees, listOperations, updateEmployee } from "../repositories/employeesRepository.js";
import type { Employee } from "../types.js";

export const contactsRouter = Router();

const requiredFields: Array<keyof Employee> = ["fio", "op", "orgUnit", "jobTitle", "phoneNumber", "jobType"];
const allFields: Array<keyof Employee> = [
  "fio",
  "op",
  "orgUnit",
  "jobTitle",
...
function normalizeEmployeeInput(body: unknown): Employee {
  ...
  return allFields.reduce<Employee>((employee, field) => {
...
async function validateEmployee(employee: Employee): Promise<string[]> {
  const errors: string[] = [];
